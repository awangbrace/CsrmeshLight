...
import com.csr.csrmeshdemo.util.CheckedListItem;
...
import com.csr.csrmeshdemo.newUI.CheckedListFragment.ItemListener;
 ...
 * 
 */
public class GroupAssignActivity extends AbActivity
implements ItemListener, GroupListener, InfoListener, RemovedListener, DataListener {
    ...
    private AbActivity mMainFragment;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setAbContentView(R.layout.group_assignment);
        try {
            mController = (DeviceController) CsrManger.getInstance(this);;
        }
        catch (ClassCastException e) {
            throw new ClassCastException(toString() + " must implement DeviceController callback interface.");
        }
        initView();
        mMainFragment = this;
...
//        setHasOptionsMenu(true);
    ...
    private void initView(){
        ...
        mApplyButton = (Button) findViewById(R.id.buttonApply);
        mCancelButton = (Button) findViewById(R.id.buttonCancel);
        mAddGroupButton = (Button) findViewById(R.id.buttonNewGroup);
        mAddDeviceButton = (Button) findViewById(R.id.buttonNewDevice);
        hideButtons();
        ...
        mApplyButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!updatesMade) {
                    // Nothing was changed.
                    Toast.makeText(GroupAssignActivity.this,GroupAssignActivity.this.getString(R.string.group_no_changes),
        ...
        mAddDeviceButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(GroupAssignActivity.this, AssociationActivity.class);
    ...
    private void initTitleBar(){
        ...
        mAbTitleBar.setTitleText(getString(R.string.group_manger));
    ...
    private void confirmRemove(final int deviceId) {
        ...
        builder.setMessage(this.getString(R.string.confirm_remove)).setCancelable(false)
                .setPositiveButton(this.getString(R.string.yes), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (deviceId >= Device.DEVICE_ADDR_BASE) {
                            ...
                            showProgress(getString(R.string.removing));
                        }
                    }
    ...
    private void confirmRemoveLocal(final int deviceId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage(this.getString(R.string.confirm_remove_local)).setCancelable(false)
                .setPositiveButton(this.getString(R.string.yes), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        // Perform remove operation.
                        mController.setSelectedDeviceId(deviceId);
    ...
    private void newGroup() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(this.getString(R.string.enter_group_name));
    ...
    private boolean sendGroupUpdate() {
        ...
        showProgress(this.getString(R.string.group_update));
    ...
    public void itemInfo(String fragmentTag, int deviceId) {
        showProgress(this.getString(R.string.waiting_for_response));
        mController.setSelectedDeviceId(deviceId);
    ...
    public void onFirmwareVersion(int deviceId, int major, int minor, boolean success) {
        ...
        if (success) {
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setMessage(this.getString(R.string.firmware_version_is) + " " + major + "." + minor).setCancelable(false)
            ...
            Toast.makeText(this, this.getString(R.string.firmware_get_fail), Toast.LENGTH_SHORT).show();
        }
    }
	...
	public void onDeviceInfoReceived(byte[] vid, byte[] pid, byte[] version , int batteryPercent, int batteryState, int deviceId,boolean success) {
        ...
        if (success) {
        	...
        	if(modelsLabel==null || modelsLabel.size()==0){
        		modelsListText = this.getString(R.string.not_support_any_model);
        	}else{
            ...
            Toast.makeText(this, this.getString(R.string.configuration_get_fail), Toast.LENGTH_SHORT).show();
        }
	...
	public void UITimeout(){
		hideProgress();
    	Toast.makeText(this, "The operation has timed out", Toast.LENGTH_SHORT).show();
	}
	...
	public void onDeviceConfigReceived(boolean success) {
		hideProgress();
		if (success) {
			Toast.makeText(this,"Device configuration updated.", Toast.LENGTH_SHORT).show();
	    	resetDeviceList();
		}
